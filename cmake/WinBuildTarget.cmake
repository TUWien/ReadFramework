...
file(GLOB RDF_AUTOMOC "${CMAKE_CURRENT_BINARY_DIR}/*_automoc.cpp")
...
if (RDF_DLL_CORE_NAME)
	...
	set(RDF_CORE_LIB optimized ${CMAKE_CURRENT_BINARY_DIR}/libs/${CORE_RELEASE_NAME}.lib debug  ${CMAKE_CURRENT_BINARY_DIR}/libs/${CORE_DEBUG_NAME}.lib)
endif()
if(RDF_DLL_MODULE_NAME)
	...
	set(RDF_MODULE_LIB optimized ${CMAKE_CURRENT_BINARY_DIR}/libs/${MODULE_RELEASE_NAME}.lib debug  ${CMAKE_CURRENT_BINARY_DIR}/libs/${MODULE_DEBUG_NAME}.lib)
endif()

set(RDF_LIBS ${RDF_CORE_LIB} ${RDF_MODULE_LIB} PARENT_SCOPE)
set(RDF_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR})
set(RDF_INCLUDE_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/src ${CMAKE_CURRENT_SOURCE_DIR}/src/Core ${CMAKE_CURRENT_SOURCE_DIR}/src/Module ${CMAKE_CURRENT_BINARY_DIR} PARENT_SCOPE)
set(RDF_BUILD_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR} PARENT_SCOPE)
set(RDF_BINARIES ${CMAKE_CURRENT_BINARY_DIR}/Debug/${MODULE_DEBUG_NAME}.dll ${CMAKE_CURRENT_BINARY_DIR}/Release/${MODULE_RELEASE_NAME}.dll ${CMAKE_CURRENT_BINARY_DIR}/Debug/${CORE_DEBUG_NAME}.dll ${CMAKE_CURRENT_BINARY_DIR}/Release/${CORE_RELEASE_NAME}.dll )
configure_file(${RDF_SOURCE_DIR}/ReadFramework.cmake.in ${CMAKE_CURRENT_BINARY_DIR}/ReadFrameworkConfig.cmake)